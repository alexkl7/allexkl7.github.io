...
//     CTX.fillText("ИГРА ЗАКОНЧЕНА", W / 2, H / 2);
//     CTX.font = "15px Poppins, sans-serif";
//     CTX.fillText(`РЕКОРД   ${score}`, W / 2, H / 2 + 60);
//     CTX.fillText(`МАКСИМАЛЬНЫЙ РЕКОРД   ${maxScore}`, W / 2, H / 2 + 80);
// }
...
//     // Удаление элементов выбора уровня сложности
//     difficultySelection.style.display = 'none';

//     // Отображение игрового поля
//     gameContainer.style.display = 'flex';

//     // Изменение размера игрового поля в зависимости от уровня сложности
//     if (difficulty === 'easy') {
...
//     // Переменные игры
//     var gridSize = 20;
//     var tileCountX = gameCanvas.width / gridSize;
//     var tileCountY = gameCanvas.height / gridSize;
//     var snake = [];
//     var snakeLength = 1;
...
//         // Запуск следующего обновления игры
//         setTimeout(updateGame, 1000 / 10); // 10 кадров в секунду
//     }

//     // Функция отрисовки части змейки
...
//         var maxX = tileCountX - 1;
//         var maxY = tileCountY - 1;
